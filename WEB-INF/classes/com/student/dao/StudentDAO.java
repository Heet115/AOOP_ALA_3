...
public class StudentDAO {
    ...
    private final String PASS = "6355"; 

    public void addStudent(String name, String email, String phone) throws Exception {
        ...
        try {
            ...
            try (PreparedStatement ps = con.prepareStatement("INSERT INTO students (name, email, phone) VALUES (?, ?, ?)", Statement.RETURN_GENERATED_KEYS)) {
                ps.setString(1, name);
    ...
    public void updateStudent(int id, String name, String email, String phone) throws Exception {
        Class.forName("com.mysql.cj.jdbc.Driver");
        try (Connection con = DriverManager.getConnection(URL, USER, PASS)) {
            ...
            try (PreparedStatement ps = con.prepareStatement("UPDATE students SET name=?, email=?, phone=? WHERE id=?")) {
                ps.setString(1, name);
                ps.setString(2, email);
                ps.setString(3, phone);
                ps.setInt(4, id);
